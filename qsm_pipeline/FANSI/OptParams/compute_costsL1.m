function [ data_cost, reg_cost ] = compute_costsL1( chi, phase, kernel )
% Calculates the costs associated with a TV regularization,
% and an L1-norm data fidelity term.
...
%
% Output:
% data_cost: Cost of the L1 (linear) data fidelity term.
